<?php $__env->startSection('title','修改用户的密码'); ?>
            ...
            <div class="panel-body panel-body-nopadding">
                ...
                <form id="password_form" class="form-horizontal form-bordered" action="/admin/user/password/save" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="<?php echo e(isset($username) ? $username : null); ?>" class="form-control" name="username" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <image src="<?php echo e(isset($user_pic) ? $user_pic : null); ?>" style="width: 70px;"/>
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="password" placeholder="输入密码" value="<?php echo e(old('password')); ?>" class="form-control" name="old_password">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="password" placeholder="输入密码" value="<?php echo e(old('password')); ?>" class="form-control" name="password">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="password" placeholder="输入确认密码" value="<?php echo e(old('password')); ?>" class="form-control" name="confirm_password">
                            <span class="help-block"></span>
                        </div>
                    </div>
                </form>
