<?php $__env->startSection('title','管理后台-商品添加'); ?>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-nopadding" v-show="tab==1">
                        ...
                        <select class="form-control" name="cate_id"> 
                            <?php if(!empty($cate_list)): ?>
                                <?php $__currentLoopData = $cate_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($cate['id']); ?>"><?php echo e(str_repeat('--',$cate['level'])); ?><?php echo e($cate['cate_name']); ?></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" placeholder="商品货号" class="form-control" name="goods_sn" value="<?php echo e($goods_sn); ?>" />
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" placeholder="上架时间" class="form-control" name="shop_time" value="<?php echo e(date('Y-m-d H:i:s')); ?>" id="shop_time"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" placeholder="发布时间" class="form-control"  name="sort" value="<?php echo e(rand(1,100)); ?>" />
                    </div>
