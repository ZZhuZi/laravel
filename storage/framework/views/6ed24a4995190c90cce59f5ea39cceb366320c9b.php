<?php $__env->startSection('title','管理后台-商品编辑'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="panel panel-default">
        ...
        <form class="form-horizontal form-bordered" action="/admin/goods/doEdit" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="id" value="<?php echo e($info->id); ?>" id="goods_id">
        <!--通用信息-->
        <div class="panel-body panel-body-nopadding" v-show="tab==1">
                        ...
                        <select class="form-control" name="cate_id">
                            <?php if(!empty($cate_list)): ?>
                                <?php $__currentLoopData = $cate_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($cate['id']); ?>" <?php echo e($info->cate_id == $cate['id'] ? "selected" : ""); ?>><?php echo e(str_repeat('--',$cate['level'])); ?><?php echo e($cate['cate_name']); ?></option>
                        ...
                        <select class="form-control" name="brand_id">
                             <?php if(!empty($brand_list)): ?>
                                <?php $__currentLoopData = $brand_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($brand['id']); ?>"  <?php echo e($info->brand_id == $brand['id'] ? "selected" : ""); ?>><?php echo e($brand['brand_name']); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                        </select>
                    </div>
                ...
                <div class="form-group">
                        ...
                        <select class="form-control" name="type_id">
                            <?php if(!empty($type_list)): ?>
                                <?php $__currentLoopData = $type_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($type['id']); ?>" <?php echo e($info->type_id == $type['id'] ? "selected" : ""); ?>><?php echo e($type['type_name']); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                        </select>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <input type="text" placeholder="商品名称" class="form-control" name="goods_name" value="<?php echo e($info->goods_name); ?>" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">商品货号</label>
                    <div class="col-sm-4">
                        <input type="text" placeholder="商品货号" class="form-control" name="goods_sn" value="<?php echo e($info->goods_sn); ?>" />
                    </div>
                    <label class="col-sm-2 control-label">关键字</label>
                    <div class="col-sm-4">
                        <input type="text" placeholder="关键字" class="form-control" name="keywords" value="<?php echo e($info->keywords); ?>" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">市场售价</label>
                    <div class="col-sm-4">
                        <input type="text" placeholder="市场售价" class="form-control" name="shop_price" value="<?php echo e($info->shop_price); ?>" />
                    </div>
                    <label class="col-sm-2 control-label">本店售价</label>
                    <div class="col-sm-4">
                        <input type="text" placeholder="本店售价" class="form-control" name="market_price" value="<?php echo e($info->market_price); ?>" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">商品库存</label>
                    <div class="col-sm-4">
                        <input type="text" placeholder="商品库存" class="form-control" name="goods_num" value="<?php echo e($info->goods_num); ?>" />
                    </div>
                    <label class="col-sm-2 control-label">库存报警</label>
                    <div class="col-sm-4">
                        <input type="text" placeholder="库存报警" class="form-control" name="warn_num" value="<?php echo e($info->warn_num); ?>" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                         <div class="radio"><label><input type="radio" name="is_shop" value="1" <?php echo e($info->is_shop == 1 ? "checked" : ""); ?>> 是</label></div>
                        <div class="radio"><label><input type="radio" name="is_shop" value="2" <?php echo e($info->is_shop == 2 ? "checked" : ""); ?>>否</label></div> 
                    </div>
                    <label class="col-sm-2 control-label">上架时间</label>
                    <div class="col-sm-4">
                        <input type="text" placeholder="上架时间" class="form-control" name="shop_time" value="<?php echo e($info->shop_time); ?>" id="shop_time"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">是否推荐</label>
                    <div class="col-sm-4">
                         <div class="radio"><label><input type="radio" name="is_recommand" value="1" <?php echo e($info->is_recommand == 1 ? "checked" : ""); ?>> 是</label></div>
                        <div class="radio"><label><input  type="radio" name="is_recommand" value="2" <?php echo e($info->is_recommand == 2 ? "checked" : ""); ?>>否</label></div> 
                    </div>
                    <label class="col-sm-2 control-label">是否最新</label>
                    <div class="col-sm-4">
                         <div class="radio"><label><input type="radio" name="is_new" value="1" <?php echo e($info->is_new == 1 ? "checked" : ""); ?>> 是</label></div>
                        <div class="radio"><label><input  type="radio" name="is_new" value="2" <?php echo e($info->is_new == 2 ? "checked" : ""); ?>>否</label></div> 
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">是否热销</label>
                    <div class="col-sm-4">
                         <div class="radio"><label><input type="radio" name="is_hot" value="1" <?php echo e($info->is_hot == 1 ? "checked" : ""); ?>> 是</label></div>
                        <div class="radio"><label><input  type="radio" name="is_hot" value="2" <?php echo e($info->is_hot == 2 ? "checked" : ""); ?>>否</label></div> 
                    </div>
                    <label class="col-sm-2 control-label">状态</label>
                    <div class="col-sm-4">
                         <div class="radio"><label><input type="radio" name="status" value="1" <?php echo e($info->status == 1 ? "checked" : ""); ?>> 待审核</label></div>
                        <div class="radio"><label><input  type="radio" name="status" value="2" <?php echo e($info->status == 2? "checked" : ""); ?>>已审核</label></div> 
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">商品排序</label>
                    <div class="col-sm-4">
                        <input type="text" placeholder="发布时间" class="form-control"  name="sort" value="<?php echo e($info->sort); ?>" />
                    </div>
                    <label class="col-sm-2 control-label">赠送积分</label>
                    <div class="col-sm-4">
                        <input type="text" placeholder="赠送积分" class="form-control"  name="give_score" value="<?php echo e($info->give_score); ?>" />
                    </div>
                </div>
        </div>
        <!--通用信息-->
        ...
        <div class="panel-body panel-body-nopadding" v-show="tab==2">
                <div class="form-group">
                    <div class="col-sm-12">
                        <textarea id="content" name="goods_desc"><?php echo e($info->goods_desc); ?></textarea>
                    </div>
                </div>
        </div>
        <!--商品详情-->
