<?php $__env->startSection('title','管理后台-用户详情'); ?>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-nopadding" v-show="tab==1">
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                     <span class="form-control"><?php echo e($info->username); ?></span>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <?php echo e($info->status==1 ? "未激活" : "正常"); ?>
                  ...
                  <?php if(!empty($bonus_list)): ?>
                   <?php $__currentLoopData = $bonus_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bonus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($bonus['min_money']); ?></td>
                    </tr>
