...
class GoodsController extends Controller
{
    ...
    public function detail($goodsId)
    {
    	...
    	$gallery = $this->getDataList($GoodsGallery,['goods_id'=>$goodsId]);

    	$oss = new ToolsOss();

    	foreach ($gallery as $key => $value) {
    		$gallery[$key]['image_url'] =file_exists($value['image_url']) ? "http://www.laravel.com/".$value['image_url'] : $oss->getUrl($value['image_url'],true);
    	}
